...
alter procedure DeleteIngredient
(
	@ingredientid int
)
as 
...
--Update Ingredient
alter procedure UpdateIngredient
(
	@name varchar(50),
	@ingredientid int,
	@recipeid int,
...
alter procedure  AdminShippingDetailsUpdate
(   
	@shippingNumber int,
...
--Search Ingredient
alter procedure SearchIngredient
(
	@ingredientid int
)
as
...
--Admin order details
alter procedure AdminOrderManager
as 
select * from OrderIngredient
go
...
alter procedure AdminViewShippingDetails
as
BEGIN
	select * from  Shipping ;
END
...
alter procedure ForgotPasswordCustomer
(
	@username varchar(50) 
)
as 
...
--query to create procedure 
alter procedure ChangePasswordCustomer
(
	@username varchar(50) output,
	@password varchar(30) output,
...
--create procedure
alter proc ViewShippingDetails
(
	@username varchar(30)
)
as
