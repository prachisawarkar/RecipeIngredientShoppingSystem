...
namespace RecipeIngredientSystem.BL
{
    ...
    {
        public static bool ValidateAdmin(Admin objadmin)
        {
        ...
        public bool AddAdminBL(Admin objAddAdmin)
        {
        ...
        public bool AdminLoginBL(Admin objLoginAdmin)
        {
            bool Login = false;
            try
            {
        ...
        public bool AdminChangePaasBL(Admin objchangepassAdmin)
        {
            bool pass = false;
            try
            {
        ...
        public  bool AdminForget(string objForgetAdmin)
        {
